        ...
        for (Empleados empleado : empleados) {
            ...
            if (empleado.getCargo().equals("junior")) {
                ...
                for (int i = 0; i < materials.size(); i++) {
                    if (materials.get(i).getNombre().equals("portatiltipo1") && !materials.get(i).isAsignado()) {
            ...
            if (empleado.getCargo().equals("senior")) {
                ...
                ArrayList<Material> materialesEmpleado = new ArrayList<>();
                for (int i = 0; i < materials.size(); i++) {
                    if (materials.get(i).getNombre().equals("portatiltipo2") && !materials.get(i).isAsignado()) {
                        materials.get(i).setAsignado(true);
            ...
            if (empleado.getCargo().equals("arquitecto")) {
                ...
                for (int i = 0; i < materials.size(); i++) {
                    ...
                    if (materials.get(i).getNombre().equals("portatiltipo3") && !materials.get(i).isAsignado()) {
                        materials.get(i).setAsignado(true);
                ...
                for (int i = 0; i < materials.size(); i++) {
                    ...
                    if (materials.get(i).getNombre().equals("telefonotipo1") && !materials.get(i).isAsignado()) {
                        materials.get(i).setAsignado(true);
            ...
            if (empleado.getCargo().equals("manager")) {
                ...
                for (int i = 0; i < materials.size(); i++) {
                    ...
                    if (materials.get(i).getNombre().equals("telefonotipo2") && !materials.get(i).isAsignado()) {
                        materials.get(i).setAsignado(true);
                        empleado.setDineroMateriales(1000 + empleado.getDineroMateriales());
                ...
                for (int i = 0; i < materials.size(); i++) {
                    ...
                    if (materials.get(i).getNombre().equals("portatiltipo4") && !materials.get(i).isAsignado()) {
                        materials.get(i).setAsignado(true);
