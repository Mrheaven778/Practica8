...
public class Empleados {
    ...
    public Empleados(String nombre, String apellido, float sueldo, int edad, String direccion) {
        this.nombre = nombre;
    ...
    /**
     * Este procedimineto siver para asignar un cargo nuevo a un empleado, si este
     * cargo no exite se volvera a pedir un cargo
     */
    public void pAsignarCargo() {
        ...
        do {
            ...
            if (Utilitis.comprbarCategoria(cargoAsignar)) {
    ...
    public float mCalcularIrpf() {
        ...
        System.out.println("El irpf es: " + this.irpf);
